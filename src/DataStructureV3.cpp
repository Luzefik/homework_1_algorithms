...
void DataStructureV3::init(vector<student> &basic_arr) {
...
void DataStructureV3::set_grade_by_email(string student_email, float new_grade) {
...
string DataStructureV3::get_top_group() {
    string best = "";
    double max_avg = -1.0;
